...
![](p8105_hw6_dw3093_files/figure-gfm/unnamed-chunk-8-1.png)<!-- --> The
residuals vs. fitted values plot reveals that residuals are mostly
centered around zero, indicating no substantial systematic bias in the
model’s predictions.
